...
namespace ExampleApplication.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        {
            /* The code begins by creating an instance of the view model and putting in it
             * the list of instructors. The code specifies eager loading for 
             * the Instructor.OfficeAssignment and the Instructor.CourseAssignments navigation 
             * properties. Within the CourseAssignments property, the Course property is loaded, 
             * and within that, the Enrollments and Department properties are loaded, 
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            //get the current Instructor entity from the database
